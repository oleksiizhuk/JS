...
const UI: Record<Lang, UiText> = {
  ru: {
    ...
    grammarNone: "Для выбранных разделов разбора грамматики пока нет (есть для Sections 2–4).",
  ...
  en: {
    ...
    grammarNone: "No grammar notes for the selected sections yet (available for Sections 2–4).",
