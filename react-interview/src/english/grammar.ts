...
export const GRAMMAR_TEXTS: Record<string, GrammarText> = {
  ...
  s4: [
    {
      text: "[[as-a-kid-dangling|As a kid, the endless summer hols meant]] six weeks of just pottering around. [[sentence-adverbs|Inevitably]] I got bored, hung around the park with mates and [[verb-ing-patterns|put off tidying up]] my room until the last day.",
    },
    {
      text: "Last year my friends [[past-perfect-continuous|had been pestering me for months]] about a getaway, and I finally said yes, [[though-position|though I was dreading it]]. We left at the crack of dawn; [[within-in-by|within three hours]] we were by the sea. [[no-ing-ellipsis|No lugging baggage — one rucksack each]]. My mate drove; [[implied-conditional|I’d never have made it otherwise]].",
    },
    {
      text: "[[emphatic-did|We did have to chip in with the washing up]], but there was plenty of time to do nothing at all. [[sentence-adverbs|Oddly]], after a week of doing nothing [[than-ellipsis|I was more shattered than after a month at work]]. Now it's back to the grindstone.",
    },
  ],
};
  ...
  s4: [
    {
      ...
      title: "had been pestering me for months: Past Perfect Continuous",
      title_en: "had been pestering me for months: Past Perfect Continuous",
      quote: "Last year my friends **had been pestering me for months** about a getaway, and I finally said yes.",
      rule: "had been + V-ing: действие длилось какое-то время ДО момента в прошлом (said yes) и подчёркивает именно длительность или повторяемость — «месяцами доставали». Сигналы: for months / for ages / all week / since. Past Perfect Simple (had pestered) сказал бы о результате или разовом факте, без ощущения процесса.",
      rule_en: "had been + V-ing: an action went on for some time BEFORE a past moment (said yes) and stresses duration or repetition — 'kept pestering for months'. Signals: for months / for ages / all week / since. Past Perfect Simple (had pestered) would state a result or a single fact, with no sense of process.",
      pattern: "had been + V-ing + for / since … + past reference point (Past Simple)",
      examples: [
        "She had been waiting for an hour when the bus finally came.",
        "We'd been planning the trip since January.",
        "He was tired because he had been driving all night.",
      ],
      it: [
        "The service had been leaking memory for days before anyone noticed.",
        "We had been arguing about the architecture for weeks when the deadline settled it.",
        "By the time QA got the build, we'd been fixing the same bug all sprint.",
      ],
      me: [
        "I'd been working with jQuery for two years when I switched to React.",
        "Before I joined, I had been freelancing for a while.",
        "I'd been thinking about a lead role for a long time before I asked for it.",
      ],
      trap: "Глаголы состояния не идут в continuous: had been knowing ✗ → had known. Если важен результат, а не процесс — Past Perfect Simple: They had pestered me into saying yes (уговорили).",
      trap_en: "Stative verbs don't take the continuous: had been knowing ✗ → had known. If the result matters more than the process — Past Perfect Simple: They had pestered me into saying yes (they succeeded).",
      task: {
        q: "Раскрой скобки: When the taxi arrived, we ___ (pack) for three hours and still weren't ready.",
        q_en: "Open the brackets: When the taxi arrived, we ___ (pack) for three hours and still weren't ready.",
        a: "had been packing",
      },
    },
    {
      id: "implied-conditional",
      title: "I’d never have made it otherwise: третье условное без if",
      title_en: "I’d never have made it otherwise: the third conditional without if",
      quote: "My mate drove; **I’d never have made it otherwise**.",
      rule: "I'd = I would. Would (never) have + V3 — результат в прошлом, которого не случилось; условие спрятано в otherwise = if he hadn't driven. Так говорят, когда if-часть и так ясна из контекста: полное «If my mate hadn't driven, I'd never have made it» звучит тяжеловесно. Make it = успеть, добраться, справиться.",
      rule_en: "I'd = I would. Would (never) have + V3 is a past result that didn't happen; the condition hides in otherwise = if he hadn't driven. People say it this way when the if-clause is obvious from context: the full 'If my mate hadn't driven, I'd never have made it' is heavy. Make it = get there / manage.",
      pattern: "…; S + would (never) have + V3 + otherwise   |   Without X, S + would have + V3",
      examples: [
        "Thanks for the reminder — I'd have forgotten otherwise.",
        "Without the map we'd have got lost.",
        "I'd never have finished on time without her help.",
      ],
      it: [
        "Good thing we had backups — we'd have lost a day's data otherwise.",
        "Without the type checker that bug would have reached production.",
        "I'd never have spotted the race condition without the logs.",
      ],
      me: [
        "My mentor pushed me to apply; I'd never have got the job otherwise.",
        "Without side projects I'd have stayed a junior much longer.",
        "I'd have burnt out otherwise, so I learnt to delegate.",
      ],
      trap: "I'd — это would или had? Перед have + V3 всегда would (I'd have made it); перед V3 напрямую — had (I'd made it = Past Perfect). Would have made ≠ would make: первое про несбывшееся прошлое, второе про гипотетическое сейчас.",
      trap_en: "Is I'd would or had? Before have + V3 it is always would (I'd have made it); directly before V3 it is had (I'd made it = Past Perfect). Would have made ≠ would make: the first is an unreal past, the second a hypothetical present.",
      task: {
        q: "Скажи без if: If you hadn't lent me the charger, my phone would have died. → …; my phone ___ otherwise.",
        q_en: "Say it without if: If you hadn't lent me the charger, my phone would have died. → …; my phone ___ otherwise.",
        a: "Thanks for the charger; my phone would have died otherwise.",
      },
    },
    {
      id: "emphatic-did",
      title: "We did have to chip in: эмфатическое did для уступки",
      title_en: "We did have to chip in: emphatic did for concession",
      quote: "**We did have to chip in with the washing up**, but there was plenty of time to do nothing at all.",
      rule: "В утверждении вспомогательный do/does/did не нужен — поэтому, когда он всё же стоит, он несёт ударение: «посуду мы, правда, мыли, но…». Это способ признать контраргумент перед but. В речи did произносится с ударением; в письме иногда выделяют курсивом. Смысловой глагол после — в базовой форме: did have, не did had.",
      rule_en: "A statement doesn't need the auxiliary do/does/did — so when it appears, it carries stress: 'we did wash up, but…'. It's a way of conceding a point before but. In speech did is stressed; in writing it is sometimes italicised. The main verb after it is the base form: did have, not did had.",
      pattern: "S + do / does / did + V1 …, but …   |   It does work — I've tested it.",
      examples: [
        "It did rain, but only for an hour.",
        "I do like him, I just don't trust him.",
        "She does know the answer; she's being modest.",
      ],
      it: [
        "The migration did take longer than planned, but nothing broke.",
        "The library does support TypeScript — the docs just don't mention it.",
        "We did consider GraphQL, but REST was enough for the MVP.",
      ],
      me: [
        "I did make mistakes early on, but I learnt fast.",
        "I do enjoy mentoring, even though it slows me down.",
        "I did have one gap year, which I spent freelancing.",
      ],
      trap: "did had ✗, does knows ✗ — после эмфатического do только базовая форма. Не превращай в вопрос: We did have to chip in — порядок слов утвердительный. С be эмфаза идёт через ударение, а не do: It IS true (не It does be true).",
      trap_en: "did had ✗, does knows ✗ — only the base form after emphatic do. Don't turn it into a question: We did have to chip in keeps statement word order. With be, emphasis is by stress, not do: It IS true (not It does be true).",
      task: {
        q: "Добавь эмфазу: I read the contract, but I missed the small print.",
        q_en: "Add emphasis: I read the contract, but I missed the small print.",
        a: "I did read the contract, but I missed the small print.",
      },
    },
    {
      id: "no-ing-ellipsis",
      title: "No lugging baggage — one rucksack each: No + V-ing и эллипсис",
      title_en: "No lugging baggage — one rucksack each: No + V-ing and ellipsis",
      quote: "**No lugging baggage — one rucksack each.**",
      rule: "No + V-ing — предложение без глагола-сказуемого: «никакого таскания багажа». На табличках это запрет (No smoking, No parking), в рассказе — «этого не было». Дальше эллипсис: one rucksack each = (we had) one rucksack each. Each в конце = «на каждого». Неформальный текст любит такие обрубленные фразы, ими задают темп.",
      rule_en: "No + V-ing is a sentence with no main verb: 'no baggage-lugging'. On signs it's a ban (No smoking, No parking); in a story it means 'there was none of that'. Then ellipsis: one rucksack each = (we had) one rucksack each. Each at the end = 'per person'. Informal writing loves these clipped phrases; they set the pace.",
      pattern: "No + V-ing (+ object).   |   noun phrase + each.   |   (we had) + noun — the verb is dropped",
      examples: [
        "No cooking this week — we're eating out.",
        "Two tickets each, no exceptions.",
        "No phones at the table.",
      ],
      it: [
        "No deploying on Fridays — team rule.",
        "No mocking the database in integration tests.",
        "One reviewer each, then merge.",
      ],
      me: [
        "No overtime for me this month — I've booked a holiday.",
        "No more spreadsheets: I automated the reporting.",
        "Two interviews each day that week; I was exhausted.",
      ],
      trap: "No + инфинитив ✗: No to lug baggage. С существительным без -ing тоже можно: No baggage. Not lugging ✗ в начале самостоятельной фразы — только No. Each ставится после числа/существительного: one rucksack each, а не each one rucksack.",
      trap_en: "No + infinitive ✗: No to lug baggage. A plain noun works too: No baggage. Not lugging ✗ at the start of a stand-alone phrase — only No. Each goes after the number/noun: one rucksack each, not each one rucksack.",
      task: {
        q: "Сократи до обрубка с No: We didn't queue for anything, we had a pass for everyone.",
        q_en: "Clip it with No: We didn't queue for anything, we had a pass for everyone.",
        a: "No queuing — a pass each.",
      },
    },
    {
      id: "verb-ing-patterns",
      title: "put off tidying up / was dreading it: глаголы, после которых только -ing",
      title_en: "put off tidying up / was dreading it: verbs followed only by -ing",
      quote: "…hung around the park with mates and **put off tidying up** my room until the last day. …I finally said yes, though I was dreading it.",
      rule: "После некоторых глаголов возможно только -ing, не to-инфинитив: put off (откладывать), avoid, keep (on), enjoy, mind, can't stand, finish, consider, dread. Put off doing = откладывать дело; dread doing / dread something = с ужасом ждать. Tidying up — фразовый глагол в -ing после другого глагола: две частицы подряд (off tidying up) в норме.",
      rule_en: "Some verbs take only -ing, never a to-infinitive: put off, avoid, keep (on), enjoy, mind, can't stand, finish, consider, dread. Put off doing = postpone; dread doing / dread something = await with fear. Tidying up is a phrasal verb in -ing after another verb: two particles in a row (off tidying up) is normal.",
      pattern: "put off / avoid / keep / enjoy / mind / can't stand / dread + V-ing",
      examples: [
        "I keep putting off going to the dentist.",
        "She avoids driving in the city.",
        "I dread having to tell him.",
      ],
      it: [
        "We kept putting off upgrading React until the security patch forced us.",
        "Avoid mutating state inside a reducer.",
        "I dread opening that 2,000-line component.",
      ],
      me: [
        "I can't stand leaving a task half-done.",
        "I enjoy pairing with juniors.",
        "I used to put off writing tests; now I write them first.",
      ],
      trap: "put off to tidy ✗, avoid to drive ✗, enjoy to swim ✗. Не путай: stop doing (перестать) vs stop to do (остановиться, чтобы); remember doing (помнить, что делал) vs remember to do (не забыть сделать).",
      trap_en: "put off to tidy ✗, avoid to drive ✗, enjoy to swim ✗. Don't confuse: stop doing (quit) vs stop to do (pause in order to); remember doing (recall) vs remember to do (not forget).",
      task: {
        q: "Исправь: I keep putting off to call the bank because I dread to speak to them.",
        q_en: "Correct: I keep putting off to call the bank because I dread to speak to them.",
        a: "I keep putting off calling the bank because I dread speaking to them.",
      },
    },
    {
      id: "as-a-kid-dangling",
      title: "As a kid, the endless summer hols meant…: as + роль и «повисший» оборот",
      title_en: "As a kid, the endless summer hols meant…: as + role and the dangling modifier",
      quote: "**As a kid, the endless summer hols meant** six weeks of just pottering around.",
      rule: "As a kid / as a student / as a developer = «в бытность, будучи». Формально оборот относится к подлежащему главной части — а здесь подлежащее hols, и выходит, что каникулы были ребёнком. Это dangling modifier: в живой речи и неформальном тексте его прощают (смысл очевиден), в письме и на собеседовании безопаснее As a kid, I spent six weeks…. As здесь — не «как» (сравнение like), а «в качестве».",
      rule_en: "As a kid / as a student / as a developer = 'when I was one'. Strictly, the phrase attaches to the main-clause subject — here that is hols, so the holidays were a kid. That's a dangling modifier: speech and informal writing forgive it (the meaning is obvious); in writing and in interviews it's safer to say As a kid, I spent six weeks…. As here is not 'like' (comparison) but 'in the role of'.",
      pattern: "As a + role, + S (the same person) + V   |   As a developer, I …",
      examples: [
        "As a student, I lived on toast.",
        "As a parent, you learn to sleep anywhere.",
        "He worked as a waiter for a year.",
      ],
      it: [
        "As a frontend developer, I care about bundle size more than most backend people.",
        "As a team, we decided to freeze features for a week.",
        "She joined as a contractor and stayed as a lead.",
      ],
      me: [
        "As a junior, I said yes to everything; now I ask why first.",
        "As a lead, I spent half my time unblocking people.",
        "As a kid, I took every gadget apart.",
      ],
      trap: "As a kid, my parents took me… ✗ (получается, родители были ребёнком) → When I was a kid, my parents…. As ≠ like: as a doctor (я врач) vs like a doctor (как врач, но не врач).",
      trap_en: "As a kid, my parents took me… ✗ (the parents were the kid) → When I was a kid, my parents…. As ≠ like: as a doctor (I am one) vs like a doctor (similar to one, but not one).",
      task: {
        q: "Почини оборот: As an intern, the codebase seemed enormous to me.",
        q_en: "Fix the modifier: As an intern, the codebase seemed enormous to me.",
        a: "As an intern, I found the codebase enormous.  /  When I was an intern, the codebase seemed enormous.",
      },
    },
    {
      id: "though-position",
      title: "…, though I was dreading it: though в середине и в конце предложения",
      title_en: "…, though I was dreading it: though mid-sentence and sentence-final",
      quote: "…and I finally said yes, **though I was dreading it**.",
      rule: "Though = although, но короче и разговорнее; вводит уступку после главной мысли: said yes, though I was dreading it. Есть ещё финальная позиция как наречие: I said yes. I was dreading it, though. — «правда». Even though — усиленное, as though = «как будто». Although в конце предложения стоять не может.",
      rule_en: "Though = although, only shorter and more conversational; it adds a concession after the main point: said yes, though I was dreading it. It also works sentence-finally as an adverb: I said yes. I was dreading it, though. Even though is the stronger form; as though = 'as if'. Although can't go at the end of a sentence.",
      pattern: "main clause, though + clause   |   sentence. Sentence, though.   |   Even though + clause, main clause",
      examples: [
        "The hotel was nice, though a bit noisy.",
        "It's expensive. It's worth it, though.",
        "Even though it rained, we went out.",
      ],
      it: [
        "The refactor is done, though the tests still need updating.",
        "The API is fast. The docs are terrible, though.",
        "Even though the demo crashed, the client signed.",
      ],
      me: [
        "I've mostly done mobile, though I'm comfortable with Node.",
        "I haven't led a team yet. I've mentored two juniors, though.",
        "Even though I started in QA, I moved into development within a year.",
      ],
      trap: "Although в конце ✗: It's worth it, although. Не ставь but и though вместе: but it was noisy, though ✗ — одно из двух. As though ≠ though: He acts as though he owns the place.",
      trap_en: "Although at the end ✗: It's worth it, although. Don't use but and though together: but it was noisy, though ✗ — pick one. As though ≠ though: He acts as though he owns the place.",
      task: {
        q: "Перепиши с though в конце: The flat is small, but it's central.",
        q_en: "Rewrite with though at the end: The flat is small, but it's central.",
        a: "The flat is small. It's central, though.",
      },
    },
    {
      id: "within-in-by",
      title: "within three hours we were by the sea: within / in / by / for со временем",
      title_en: "within three hours we were by the sea: within / in / by / for with time",
      quote: "We left at the crack of dawn; **within three hours** we were by the sea.",
      rule: "Within three hours = не позже чем через три часа, в пределах (ускорение, «уже через»). In three hours = ровно через три часа (точка). For three hours = в течение трёх часов (длительность). By three o'clock = к трём (дедлайн). At the crack of dawn — at с точкой времени; by the sea здесь другой by — «у моря» (место).",
      rule_en: "Within three hours = no later than three hours from now, inside that limit ('in under three hours'). In three hours = after exactly three hours (a point). For three hours = a three-hour duration. By three o'clock = a deadline. At the crack of dawn — at with a point in time; by the sea is a different by — location.",
      pattern: "within + span (limit) · in + span (after) · for + span (duration) · by + point (deadline) · at + point",
      examples: [
        "Reply within five working days.",
        "I'll be back in ten minutes.",
        "We walked for two hours and were home by six.",
      ],
      it: [
        "The page must respond within 200 ms.",
        "The token expires in an hour.",
        "The outage lasted for forty minutes; service was back by noon.",
      ],
      me: [
        "I can usually get up to speed on a new codebase within a week.",
        "I'm available to start in a month.",
        "I worked there for three years, and by the end I was leading the mobile team.",
      ],
      trap: "During three hours ✗ → for three hours (during + событие: during the flight). Within ≠ in: I'll answer within an hour (не позже часа) vs in an hour (через час, не раньше). Until ≠ by: stay until six (до шести) vs be there by six (к шести).",
      trap_en: "During three hours ✗ → for three hours (during + an event: during the flight). Within ≠ in: I'll answer within an hour (any time up to an hour) vs in an hour (an hour from now). Until ≠ by: stay until six (all the way to six) vs be there by six (no later than six).",
      task: {
        q: "Вставь within / in / for / by: The courier promises delivery ___ 24 hours; I'll call you ___ five minutes; we waited ___ an hour; be home ___ midnight.",
        q_en: "Fill in within / in / for / by: The courier promises delivery ___ 24 hours; I'll call you ___ five minutes; we waited ___ an hour; be home ___ midnight.",
        a: "within · in · for · by",
      },
    },
    {
      id: "sentence-adverbs",
      title: "Inevitably I got bored / Oddly, …: наречия-комментарии в начале предложения",
      title_en: "Inevitably I got bored / Oddly, …: sentence adverbs",
      quote: "**Inevitably** I got bored, hung around the park with mates… / **Oddly**, after a week of doing nothing I was more shattered than after a month at work.",
      rule: "Sentence adverb относится не к глаголу, а ко всему предложению и выражает отношение говорящего: inevitably (как и следовало ожидать), oddly / strangely (странно, но), sadly, luckily, frankly, predictably, admittedly. Стоит в начале с запятой (Oddly, …) или в середине между подлежащим и глаголом (I inevitably got bored). Часто + enough: oddly enough, funnily enough.",
      rule_en: "A sentence adverb modifies the whole sentence, not the verb, and shows the speaker's attitude: inevitably (as was bound to happen), oddly / strangely, sadly, luckily, frankly, predictably, admittedly. It goes first with a comma (Oddly, …) or mid-position between subject and verb (I inevitably got bored). Often + enough: oddly enough, funnily enough.",
      pattern: "Adverb, + sentence   |   S + adverb + V   |   Oddly / Funnily enough, …",
      examples: [
        "Luckily, nobody was hurt.",
        "Predictably, the train was late.",
        "Frankly, I don't care.",
      ],
      it: [
        "Inevitably, the hotfix introduced a new bug.",
        "Oddly enough, the crash only happens on Tuesdays.",
        "Admittedly, the test coverage is thin.",
      ],
      me: [
        "Frankly, I prefer smaller teams.",
        "Luckily, my first manager was a great mentor.",
        "Predictably, my first app had no tests.",
      ],
      trap: "Oddly ≠ in an odd way: She smiled oddly (странно улыбнулась — про глагол) vs Oddly, she smiled (странно, что улыбнулась — про всё предложение). Запятая после наречия в начале обязательна в письме. Hopefully в значении «надеюсь» — норма в речи, пуристы морщатся в письме.",
      trap_en: "Oddly ≠ in an odd way: She smiled oddly (her smile was odd — about the verb) vs Oddly, she smiled (it's odd that she smiled — about the sentence). The comma after a sentence-initial adverb is required in writing. Hopefully meaning 'I hope' is fine in speech; purists frown on it in writing.",
      task: {
        q: "Вырази отношение одним наречием в начале: It was strange, but the cheapest hotel turned out to be the best.",
        q_en: "Express the attitude with one adverb up front: It was strange, but the cheapest hotel turned out to be the best.",
        a: "Oddly (enough), the cheapest hotel turned out to be the best.",
      },
    },
    {
      id: "than-ellipsis",
      title: "more shattered than after a month at work: сравнение с пропуском",
      title_en: "more shattered than after a month at work: comparison with ellipsis",
      quote: "…after a week of doing nothing **I was more shattered than after a month at work**.",
      rule: "После than выброшено всё, что повторяется: than (I was shattered) after a month at work. Английский сравнивает «обстоятельство с обстоятельством» и опускает общую часть — так делают и в речи, и в письме. Рядом: a week of doing nothing — после предлога только -ing; nothing at all — усиление «вообще ничего».",
      rule_en: "After than everything that repeats is dropped: than (I was shattered) after a month at work. English compares 'circumstance with circumstance' and cuts the shared part — in speech and in writing. Nearby: a week of doing nothing — only -ing after a preposition; nothing at all = emphatic 'absolutely nothing'.",
      pattern: "S + be + more/-er + adj + than + (S + be + adj) + prepositional phrase   |   preposition + V-ing",
      examples: [
        "I feel better today than yesterday.",
        "It's colder inside than out.",
        "She's happier at home than in the office.",
      ],
      it: [
        "The app is slower on Android than on iOS.",
        "Reviews take longer on Fridays than mid-week.",
        "The code is cleaner after the refactor than before it.",
      ],
      me: [
        "I'm more productive in the morning than after lunch.",
        "I learn faster on a real project than from a course.",
        "I was more nervous at my first stand-up than at the interview.",
      ],
      trap: "than me / than I? В речи than me норма; than I am — формально. Опасность двусмысленности: I like her more than him (чем его) vs more than he does (чем он). После of / after / before / without — -ing, не инфинитив: after a week of to do nothing ✗.",
      trap_en: "than me / than I? In speech than me is normal; than I am is formal. Watch ambiguity: I like her more than him (than I like him) vs more than he does. After of / after / before / without use -ing, never an infinitive: after a week of to do nothing ✗.",
      task: {
        q: "Сократи: Working from home is more tiring than working in the office is.",
        q_en: "Shorten: Working from home is more tiring than working in the office is.",
        a: "Working from home is more tiring than in the office.",
      },
    },
  ],
};
